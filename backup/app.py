...
model = joblib.load(r"C:\Users\chand\Desktop\Deforestation Detection\best_fire_detection_model.pkl")
scaler = joblib.load(r"C:\Users\chand\Desktop\Deforestation Detection\scaler.pkl")
# Set page title
